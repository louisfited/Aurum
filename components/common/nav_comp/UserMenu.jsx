...
// const UserMenu = ({ userDetails, logOut, isLoading, isPending, loading }) => {
...
//         ) : (
//           <FaUserCircle
//             className={` text-4xl text-primary ${isOpen && "text-primary"}`}
//           />
//         )}
//       </button>
//       {isOpen && (
...
//                   <FaUser className="text-4xl m-[6px] text-sky-500 rounded-full" />
//                 </p>
//               )}
