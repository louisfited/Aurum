...
const headingClass = "py-3 dark:bg-gray-500 bg-gray-300 px-2"
const Page = () => {
...
<section className=' pt-2 bg-white dark:bg-darkOne rounded-lg'>
    ...
    <div className='dark:bg-gray-500 bg-gray-300 py-2 px-2 rounded-t-lg px-4 text-sm'>see your holdings</div>
</section>
...
<div className='mt-6 dark:bg-darkOne bg-white rounded-lg  overflow-hidden'>
    ...
    <aside className='flex justify-between border-t-2 border-gray-500 p-2 font-semibold'>
       ...
       <div className='w-[25%]  flex justify-between'>
       <span>$10.84</span>
       <span className='bg-gray-500 rounded-lg px-2 font-light lg:block hidden'>Set Currency</span>
       </div>
    </aside>
    <aside className='flex justify-between lg:flex-row items-center flex-col border-t-2 border-gray-500 px-2 py-6 text-sm dark:bg-gray-500 bg-gray-300 opacity-80'>
...
<div className='my-8 flex flex-col  dark:bg-darkOne bg-white rounded-t-lg overflow-hidden'>
...
<span className='w-[30%]'>{item.total}</span>
     ...
     {showItem == item.name &&   <aside>
           ...
           <article className='flex items-center justify-between'>
            ...
            <select name="" id="" className='dark:bg-darkOne w-[30%]'>
...
{silverData.map((item,index)=>{
    ...
    return <aside key={index + 1} className='flex justify-between border-t-2 py-2 px-2   '>
        ...
        <div className='w-[30%] flex justify-between '>
            ...
            <select name="" id="" className='dark:bg-darkOne lg:inline hidden w-[30%]'>
                {item.sellAtBestPrice.length > 0 && item.sellAtBestPrice.map((option,optionIndex)=>{
